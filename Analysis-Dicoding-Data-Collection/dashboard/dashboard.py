# Menjalankan kode pada streamlit menggunakan printah terminal
# perintah terminal: streamlit run dashboard.py
...
# menyiapkan DataFrame(helper function)
...
# memastikan order_date dan delivery_date bertipe datetime
...
# membuat komponen filter dengan menggunakan date input serta
# menambahkan logo perusahaan pada sidebar
...
# menampilkan jumlah order harian
...
# menampilkan nilai rata-rata dari ketiga parameter RFM(Recency, Frequency, & Monetary)
# menggunakan widget metric()
...
st.caption('Copyright (c) Gibran 2024')
