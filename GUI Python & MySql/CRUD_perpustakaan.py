...
tk.Button(root, text="Cari", command=Search, height=1, width=10).place(x=1000, y=5)

cols = ('nama buku', 'id buku', 'id petugas', 'id mhs', 'tanggal pinjam', 'jumlah pinjam')
